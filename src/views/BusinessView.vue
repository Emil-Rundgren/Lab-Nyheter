...
export default {
  data() {
    return {
      ...
      showAlert: false,
      category: 'business' // This sets the category for this component
    }
  },
  computed: {
    ...
    async getNews() {
      try {
        const response = await axios.get(
          'https://newsapi.org/v2/top-headlines?category=business&country=us&apiKey=65198de0fc7e418eb3db417f3e104479'
        )
